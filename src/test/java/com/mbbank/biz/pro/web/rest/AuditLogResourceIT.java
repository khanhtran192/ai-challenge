...
class AuditLogResourceIT {
    ...
    public static AuditLog createEntity(EntityManager em) {
        AuditLog auditLog = new AuditLog().action(DEFAULT_ACTION).detail(DEFAULT_DETAIL).createdAt(DEFAULT_CREATED_AT);
        // Add required entity
        AppUser appUser;
    ...
    public static AuditLog createUpdatedEntity(EntityManager em) {
        AuditLog updatedAuditLog = new AuditLog().action(UPDATED_ACTION).detail(UPDATED_DETAIL).createdAt(UPDATED_CREATED_AT);
        // Add required entity
        AppUser appUser;
        if (TestUtil.findAll(em, AppUser.class).isEmpty()) {
        ...
        updatedAuditLog.setUser(appUser);
    ...
    @Test
    @Transactional
    void getAllAuditLogsByDocumentIsEqualToSomething() throws Exception {
        Document document;
        ...
        // Get all the auditLogList where document equals to documentId
        defaultAuditLogShouldBeFound("documentId.equals=" + documentId);

        // Get all the auditLogList where document equals to (documentId + 1)
        defaultAuditLogShouldNotBeFound("documentId.equals=" + (documentId + 1));
    }
    ...
    void putExistingAuditLog() throws Exception {
        ...
        updatedAuditLog.action(UPDATED_ACTION).detail(UPDATED_DETAIL).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateAuditLogWithPatch() throws Exception {
        ...
        partialUpdatedAuditLog.action(UPDATED_ACTION).detail(UPDATED_DETAIL).createdAt(UPDATED_CREATED_AT);
