...
export class AuditLogUpdateComponent implements OnInit {
  ...
  protected loadRelationshipsOptions(): void {
    this.appUserService
      ...
      .pipe(map((appUsers: IAppUser[]) => this.appUserService.addAppUserToCollectionIfMissing<IAppUser>(appUsers, this.auditLog?.user)))
    ...
    this.documentService
      ...
      .pipe(
        map((documents: IDocument[]) =>
          this.documentService.addDocumentToCollectionIfMissing<IDocument>(documents, this.auditLog?.document),
        ),
      )
